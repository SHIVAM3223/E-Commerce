...
function OrderPage() {
  ...
  const getData = () => {
    ...
    // fetch(`https://db-one-delta.vercel.app/api/orderedProducts`)
    //     .then((res) => (res.json()))
    //     .then((res) => {
    //         setOrder(res);
          ...
          {Order.map((item) => (
            ...
            >
              ...
              <Text display="flex" fontSize={"14px"} alignItems="center">
                {" "}
                <BiRadioCircle color="green" size="16px" /> Delivery Expected By
                Nov 20
              </Text>
            </Flex>
          ))}
          ...
          {Order.map((item) => (
            ...
            >
              ...
              <Box>
                ...
                >
                  {" "}
                  Delivery Expected By Nov 20
                </Text>
                <Text pt="15px" w="220px" fontSize="12px" fontWeight={"light"}>
                  {" "}
                  {item.description}
                </Text>
              </Box>
